 ...
 */
int updateTruckCapacity(struct Truck* truck, const struct PackageInfo* shipment) {
    ...
    truck->packages[truck->packageCount++] = shipment; // Add the package to the truck's list
